...
Hostname        : $(hostname)
lan=$(curl
lan= LAN Address$(ip a s |awk '/: e/{gsub(/:/,"");print $2}')
lan2= Address$(ip a|awk '/inet /{gsub(/\/.*/,"");print $2}')

getent= LAN Hostname$(getent hosts |awk '/: e/{gsub(/:/,"");print $2}')
getent2= LAN Hostname$(ip a s |awk '/inet /{gsub(/\/.*/,"");print $2}')
getent3= LAN Hostname$(ip a | awk '{print $2}')
